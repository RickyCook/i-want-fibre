...
function geoToQueryParams(geo, address) {
...
function withGeo(address, key, sendResponse, geo) {
    ...
    if (geo.status == 'OK') {
        ...
        nbn_req_data = geoToQueryParams(geo, address)
        ...
        $.get('http://www.nbnco.com.au/api/map/search.html', nbn_req_data, function(response) {
